...
$route['Transaksi-keluar-delete/(:any)'] = "Transaksi/keluar_delete/$1";
...
$route['Export-pdf-stok-barang'] = "Laporan/export_pdf_stokbarang";
$route['Export-excel-stok-barang'] = "Laporan/export_excel_stokbarang";
$route['Export-excel-trxin/(:any)/(:any)'] = "Laporan/export_excel_trxin/$1/$2";
$route['Export-excel-trxout/(:any)/(:any)'] = "Laporan/export_excel_trxout/$1/$2";
