...
class Transaksi extends CI_Controller
{
  ...
  { 
    ...
    $suratjalan  = $this->input->post('surat_jalan');
  ...
  function keluar_delete($id)
  {
    $where = array ('pk_transaksi_keluar_id' => $id);
    $hasil = $this->MTransaksi->hapus_data($where, 'tbl_transaksi_keluar');
